...
import Carrinho from '../Components/Mercado/Carrinho.vue'
import Filtros from '../Components/Mercado/Filtros.vue'
import ProdutoCard from '../Components/Mercado/ProdutoCard.vue'
import Rodape from '../Components/Mercado/Rodape.vue'
import HeaderMain from '../View/MercadoMain.vue'
